...
maplibre(
  ...
  add_categorical_legend(
    ...
    colors = c("#ffffff", "#fecaca", "#f87171", "#dc2626", "#7f1d1d"),
...
EcoData se especializa en el análisis de datos ambientales y urbanos para promover el desarrollo sostenible. Este dashboard forma parte de nuestros proyectos de análisis de datos geoespaciales.

### Contacto

**Email:** ecodatayucatan@gmail.com

**Redes Sociales:**
- **Instagram:** [@ecodata_yucatan](https://instagram.com/ecodata_yucatan)
- **Facebook:** [EcoData Yucatán](https://www.facebook.com/profile.php?id=61556928127006)

### Sobre este Proyecto

Este análisis de densidad de Airbnb en Mérida, Yucatán utiliza hexágonos para visualizar patrones espaciales de propiedades de alojamiento. La herramienta permite identificar zonas de concentración turística y sus características de precio y calidad.